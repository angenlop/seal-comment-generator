        ...
        dialog.innerHTML = `
            <div style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);
                ...
                <div style="margin-bottom: 10px;">
                    ...
                    <input type="text" id="rackAsset" style="width: calc(100% - 16px); padding: 10px 8px; border: 1px solid #ced4da; border-radius: 4px; font-size: 13px; box-sizing: border-box;"
                           placeholder="Enter ID number">
                </div>

                <div style="margin-bottom: 10px;">
                    <label style="font-size: 12px; font-weight: 500; color: #495057; display: block; margin-bottom: 4px;">Seal #</label>
                    <input type="text" id="sealNumber" style="width: calc(100% - 16px); padding: 10px 8px; border: 1px solid #ced4da; border-radius: 4px; font-size: 13px; box-sizing: border-box;"
                ...
                <div style="margin-bottom: 14px;">
                    ...
                    <input type="text" id="sealNumber2" style="width: calc(100% - 16px); padding: 10px 8px; border: 1px solid #ced4da; border-radius: 4px; font-size: 13px; box-sizing: border-box;"
